...
ActiveRecord::Schema.define(:version => 20110715021358) do

  create_table "Master", :primary_key => "primary_id", :force => true do |t|
    t.text "chs_name",     :null => false
    t.text "chs_address1", :null => false
    t.text "chs_address2", :null => false
    t.text "chs_city",     :null => false
    t.text "chs_state",    :null => false
    t.text "chs_country",  :null => false
    t.text "chs_zip",      :null => false
    t.text "chs_phone",    :null => false
    t.text "chs_email",    :null => false
  end
